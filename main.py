    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                web_keyword = ['react', 'django', 'node jS', 'html','css','react js', 'php', 'laravel', 'magento', 'wordpress',
                               'javascript', 'angular js', 'c#', 'flask']
                android_keyword = ['android','android development','flutter','kotlin','java','xml','kivy']
                ios_keyword = ['ios','ios development','swift','cocoa','cocoa touch','xcode']
                uiux_keyword = ['ux','adobe xd','figma','zeplin','balsamiq','ui','prototyping','wireframes','storyframes','adobe photoshop','photoshop','editing','adobe illustrator','illustrator','adobe after effects','after effects','adobe premier pro','premier pro','adobe indesign','indesign','wireframe','solid','grasp','user research','user experience']
                cl_keyword = ['AWS','Microsoft Azure','Google Cloud','Jenkins','Gitlab','Docker']
                ...
                for i in resume_data['skills']:
                    ...
                    if i.lower() in ds_keyword:
                        ...
                        recommended_skills = ['Clustering & Classification','Data Analytics','Quantitative Analysis','Web Scraping','ML Algorithms','Keras','Pytorch','Probability','Scikit-learn','Tensorflow',"Flask",'Streamlit']
                    ...
                    ## IOS App Development
                        ...
                        recommended_skills = ['IOS','IOS Development','Swift','Cocoa','Cocoa Touch','Xcode','Objective-C','SQLite','StoreKit',"UI-Kit",'Auto-Layout']
                        recommended_keywords = st_tags(label='### Recommended skills for you.',
                    ...
                    ## Cloud Engineer Recommendation
                    elif i.lower() in cl_keyword:
                        print(i.lower())
                        reco_field = 'Cloud Engineer'
                        st.success("** Our analysis says you are looking for Cloud Engineer Jobs **")
                        recommended_skills = ['Kubernetes','Amazon RDS','CI/CD Pipelines','Python','Java']
                        recommended_keywords = st_tags(label='### Recommended skills for you.',
                        text='Recommended skills generated from System',value=recommended_skills,key = '6')
                        st.markdown('''<h4 style='text-align: left; color: #1ed760;'>Adding this skills to resume will boost🚀 the chances of getting a Job💼</h4>''',unsafe_allow_html=True)
                        rec_course = course_recommender(cl_course)
                        break
                ...
                st.markdown("[https://youtu.be/yp693O87GmM]")
                st.markdown("[https://youtu.be/y8YH0Qbu5h4]")
                st.markdown("[https://youtu.be/CLUsplI4xMU]")
                st.markdown("[https://youtu.be/pbczsLkv7Cc]")


                ## Interview Preparation Video
                st.header("**Bonus Video for Interview👨‍💼 Tips💡**")
                st.markdown("[https://youtu.be/Ji46s5BHdr0]")
                st.markdown("[https://youtu.be/seVxXHi2YMs]")
                st.markdown("[https://youtu.be/9FgfsLa_SmY]")
                st.markdown("[https://youtu.be/2HQmjLu-6RQ]")
        ...
        if st.button('Login'):
            if ad_user == 'four_engineer' and ad_password == 'engineer@123':
                st.success("Welcome Engineers")
                # Display Data
               ...
               ## Pie chart for predicted field recommendations
                ...
                fig = px.pie(values=values, names=labels, title='Predicted Field according to the Skills')  # Use plot_data here, not df
                st.plotly_chart(fig)
                ...
                fig = px.pie(values=values, names=labels, title="Pie-Chart📈 for User's👨‍💻 Experienced Level")  # Use plot_data here, not df
                st.plotly_chart(fig)

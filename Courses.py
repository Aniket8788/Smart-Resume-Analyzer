...
cl_course = [['Cloud computing by NPTEL','https://onlinecourses.nptel.ac.in/noc21_cs14/preview'],
             ['Introduction to cloud computing on amazon aws for beginners','https://www.udemy.com/course/introduction-to-cloud-computing-on-amazon-aws-for-beginners/'],
             ['Cloud Computing Architecture','https://www.mygreatlearning.com/academy/learn-for-free/courses/cloud-computing-architecture'],
             ['Grow Skills with Google Cloud Training','https://cloud.google.com/learn/training/'],
             ['AWS for Beginners','https://www.simplilearn.com/free-aws-basics-beginners-course-skillup'],
             ['Saas in cloud computing','https://www.mygreatlearning.com/academy/learn-for-free/courses/saas-in-cloud-computing'],
             ['Advanced Cloud','https://alison.com/course/comptia-cloud-advanced'],
             ['Diploma in Amazon Web Services','https://alison.com/course/diploma-in-amazon-web-services'],
             ['Learn visualization in cloud computing','https://www.mygreatlearning.com/academy/learn-for-free/courses/virtual-cloud-computing'],
             ['Microsoft Azure: From Zero to Hero','https://www.udemy.com/course/microsoft-azure-from-zero-to-hero-the-complete-guide/?utm_source=adwords-pmax&utm_medium=udemyads&utm_campaign=PMax_la.EN_cc.INDIA&utm_content=deal4584&utm_term=_._ag__._kw__._ad__._de_c_._dm__._pl__._ti__._li_1007780_._pd__._&gad_source=1&gclid=CjwKCAiA75itBhA6EiwAkho9ex4mqMTE6xtwTHgyb1v7f6HDJzYkH-ehMRMJcXa4_ZerE5tBuIyxPhoCqzwQAvD_BwE']]
